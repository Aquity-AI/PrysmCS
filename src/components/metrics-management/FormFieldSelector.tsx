    ...
    sections: [
      {
        ...
        fields: [
          { id: 'new_enrollments', label: 'New Customers This Month', fieldType: 'number' },
          { id: 'enrollment_target', label: 'Monthly Customer Target', fieldType: 'number' },
          { id: 'conversion_rate', label: 'Customer Conversion Rate', fieldType: 'number' }
        ]
      }
    ]
  },
