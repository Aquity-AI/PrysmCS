...
import { TrendingUp, Plus, Edit2, Trash2, Search, Filter, Activity, DollarSign, Users, Target, BarChart2, Eye, EyeOff, AlertCircle } from 'lucide-react';
  ...
  return (
    <div style={{ padding: '24px' }}>
      <div style={{ marginBottom: '24px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '16px' }}>
        <div>
          <h2 style={{ margin: '0 0 8px 0', fontSize: '24px', fontWeight: '600', color: '#1e293b', display: 'flex', alignItems: 'center', gap: '8px' }}>
            <TrendingUp size={28} />
            Metrics Management
          </h2>
          <p style={{ margin: 0, color: '#64748b', fontSize: '14px' }}>
            Create and manage metrics for time-series charts and analytics
          </p>
        </div>
        <button
      ...
      {filteredMetrics.length === 0 ? (
        <div style={{
          ...
          <h3 style={{ margin: '0 0 8px 0', color: '#475569', fontSize: '18px', fontWeight: '600' }}>
            ...
            return (
              ...
              >
                ...
                <div style={{
                  ...
                  <div>
                    <div style={{ color: '#94a3b8', marginBottom: '2px' }}>Type</div>
                    <div style={{ color: '#1e293b', fontWeight: '500' }}>{getDataTypeLabel(metric.data_type)}</div>
                  </div>
                  <div>
                    <div style={{ color: '#94a3b8', marginBottom: '2px' }}>Unit</div>
                    <div style={{ color: '#1e293b', fontWeight: '500' }}>{metric.unit || '—'}</div>
                  </div>
                  <div>
                    <div style={{ color: '#94a3b8', marginBottom: '2px' }}>Data Points</div>
                    <div style={{ color: '#1e293b', fontWeight: '500' }}>{dataPointCount}</div>
                  </div>
                  <div>
