          ...
          <div style={{ marginBottom: '32px' }}>
            ...
            <div style={{ marginTop: '16px' }}>
              ...
              <div style={{ display: 'flex', gap: '8px', marginBottom: '8px', flexWrap: 'wrap' }}>
                <button
                  type="button"
                  onClick={() => setConfig({ ...config, width_units: 3 })}
                  style={{
                    padding: '6px 12px',
                    background: config.width_units === 3 ? 'var(--brand-primary)' : 'white',
                    color: config.width_units === 3 ? 'white' : 'var(--slate-700)',
                    border: `1px solid ${config.width_units === 3 ? 'var(--brand-primary)' : 'var(--slate-300)'}`,
                    borderRadius: '6px',
                    cursor: 'pointer',
                    fontSize: '13px',
                    fontWeight: 500,
                ...
                <button
                  type="button"
                  onClick={() => setConfig({ ...config, width_units: 4 })}
                  style={{
                    padding: '6px 12px',
                    background: config.width_units === 4 ? 'var(--brand-primary)' : 'white',
                    color: config.width_units === 4 ? 'white' : 'var(--slate-700)',
                    border: `1px solid ${config.width_units === 4 ? 'var(--brand-primary)' : 'var(--slate-300)'}`,
                    borderRadius: '6px',
                    cursor: 'pointer',
                    fontSize: '13px',
                    fontWeight: 500,
                ...
                <button
                  type="button"
                  onClick={() => setConfig({ ...config, width_units: 6 })}
                  style={{
                    padding: '6px 12px',
                    background: config.width_units === 6 ? 'var(--brand-primary)' : 'white',
                    color: config.width_units === 6 ? 'white' : 'var(--slate-700)',
                    border: `1px solid ${config.width_units === 6 ? 'var(--brand-primary)' : 'var(--slate-300)'}`,
                    borderRadius: '6px',
                    cursor: 'pointer',
                    fontSize: '13px',
                    fontWeight: 500,
                ...
                <button
                  type="button"
                  onClick={() => setConfig({ ...config, width_units: 8 })}
                  style={{
                    padding: '6px 12px',
                    background: config.width_units === 8 ? 'var(--brand-primary)' : 'white',
                    color: config.width_units === 8 ? 'white' : 'var(--slate-700)',
                    border: `1px solid ${config.width_units === 8 ? 'var(--brand-primary)' : 'var(--slate-300)'}`,
                    borderRadius: '6px',
                    cursor: 'pointer',
                    fontSize: '13px',
                    fontWeight: 500,
                ...
                <button
                  type="button"
                  onClick={() => setConfig({ ...config, width_units: 12 })}
                  style={{
                    padding: '6px 12px',
                    background: config.width_units === 12 ? 'var(--brand-primary)' : 'white',
                    color: config.width_units === 12 ? 'white' : 'var(--slate-700)',
                    border: `1px solid ${config.width_units === 12 ? 'var(--brand-primary)' : 'var(--slate-300)'}`,
                    borderRadius: '6px',
                    cursor: 'pointer',
                    fontSize: '13px',
                    fontWeight: 500,
              ...
              <input
                ...
                onChange={(e) => {
                  ...
                  setConfig({ ...config, width_units: Math.max(1, Math.min(12, value)) });
                }}
                min="1"
                max="12"
                step="1"
